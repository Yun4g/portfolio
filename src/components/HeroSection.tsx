    ...
    <section id="home" className="relative isolate min-h-screen overflow-hidden px-4 pt-24 pb-20 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-12 lg:flex-row lg:items-center lg:justify-between">
        ...
        >
          ...
          <a href="/DtechCv3.pdf" download="/DtechCv3.pdf" className="inline-flex items-center justify-center rounded-full border border-white/10 bg-white/10 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/20">
