...
const Navbar = () => {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-[1000]">
      <div className={`mx-auto flex h-20 max-w-6xl items-center justify-between px-4 transition-all duration-300 ${isScrolled ? "backdrop-blur-2xl bg-slate-950/80  shadow-black/20" : "bg-transparent"}`}>
        <a href="#home" className="flex items-center gap-3 text-white">
          <div className="flex h-12 w-12 items-center justify-center rounded-3xl bg-white/10 ring-1 ring-white/10  shadow-violet-500/10">
      ...
      {isMenuOpen && (
        <div className="mx-4 mt-4 rounded-3xl border border-white/10 bg-slate-950/95 p-5  shadow-black/30 backdrop-blur-2xl md:hidden">
          <div className="flex flex-col gap-4">
            ...
            <a href="/DtechCv3.pdf" download="/DtechCv3.pdf" className="inline-flex h-12 items-center justify-center rounded-2xl bg-gradient-to-r from-violet-500 via-fuchsia-500 to-cyan-500 text-sm font-semibold text-white transition hover:-translate-y-0.5">
